...
imageDB.on('connection', function(sock) {
    console.log("Client-" + ++numOfConn + " is connected at time stamp: " + singleton.getTimestamp())

    handler.handleClientJoining(sock, numOfConn); //called for each client joining
});
